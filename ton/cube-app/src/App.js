...
import { FaAndroid, FaApple, FaTwitterSquare, FaFacebookSquare, FaYoutube, FaGooglePlay, FaRss, FaCode, FaEnvelope, FaList, FaMixcloud, FaSun, FaBolt } from 'react-icons/fa';
import './App.css';
...
function App() {
  return (
    ...
    <main className="wrap">
    <video src="../public/bg.mp4" loop autoplay muted></video>
    <section id="circle">
      <Face1/>
      <Face2/>
 <Face3/>
